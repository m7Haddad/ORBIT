...
Verbatim copy of docs/specs/schema.sql as of Stage 1 (2026-07-14). The spec
file may evolve; this migration must not — any later schema change is a new
...
def downgrade() -> None:
    # Reverse-dependency order. pgcrypto stays installed: it is shared
    # infrastructure, not owned by this migration.
    op.execute(
        """
        ...
        DROP TABLE IF EXISTS capability_readings;
        ...
        DROP TYPE IF EXISTS capability_data_type;
        DROP TYPE IF EXISTS capability_access;
